var store = [{
        ...
        "excerpt":"문제: 백준 2667 (c++) 풀이과정 문제를 보면 조건에서 사용한 동전의 구성이 같은데, 순서만 다르다면 같은 경우로 본다는 내용이 있다. 이 조건을 생각하며 풀이를 해봤을 때 동전이 1, 2, 5가 있을 경우 우선 dp[0]에 1을 넣음으로써 아무것도 선택하지 않을 경우를 보장해 주고 동전 1로 10을 만드는 경우를 본다면 1로 1을 만들...","categories": ["algorithm"],
        "tags": ["dp"],
        "url": "/algorithm/2293/",
        "teaser": null
      }]
